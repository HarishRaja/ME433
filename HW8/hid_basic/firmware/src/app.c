            ...
            else if( appData.hidDataReceived )
            {
                ...
                switch(appData.receiveDataBuffer[0])
                {
                    case 0x0:
                        ...
                        //int number = appData.receiveDataBuffer[1];
                        //sprintf(buffer,"Hello World %d!", appData.receiveDataBuffer[1]);

                        //write_to_display(10,10,buffer);
                        
                        //for(i=3;i<28;i++){
                        //    buffer[i-3] = appData.receiveDataBuffer[i];
                        //}

                        display_clear();
                        
                        write_to_display(10,appData.receiveDataBuffer[1],appData.receiveDataBuffer);
                        //write_to_display(10,10,buffer);
