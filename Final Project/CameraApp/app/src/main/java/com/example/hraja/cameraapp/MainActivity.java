package com.example.hraja.cameraapp;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextuqqqqreListener {
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for(startY = 15; startY<480; startY=startY+240) {
