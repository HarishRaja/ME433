...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/cdc_serial_emulator_work.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-pic32mx795_pim_e16_int_dyn.mk dist/${CND_CONF}/${IMAGE_TYPE}/cdc_serial_emulator_work.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/cdc_serial_emulator_work.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  ../../../../../../bin/framework/peripheral/PIC32MX795F512L_peripherals.a 
	...
	${MP_CC_DIR}/xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/cdc_serial_emulator_work.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
